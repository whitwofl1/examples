    ...
    policies: [
        {
            ...
            validateResource: validateTypedResource(azure.network.NetworkInterface.isInstance, (it, args, reportViolation) => {
        ...
        },
        {
            ...
            validateResource: validateTypedResource(azure.network.NetworkSecurityRule.isInstance, (it, args, reportViolation) => {
                if (it.sourceAddressPrefix === "*") {
