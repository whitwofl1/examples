    ...
    policies: [
        {
            ...
            validateResource: validateTypedResource(gcp.compute.Instance.isInstance, (it, args, reportViolation) => {
        ...
        },
        {
            ...
            validateResource: validateTypedResource(gcp.compute.Firewall.isInstance, (it, args, reportViolation) => {
